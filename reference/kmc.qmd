...
| `rng`             | np.random.BitGenerator | to generate random numbers in the KMC step                               | `default_rng()` |
| `MD_time`         | Union\[float, None\]   | to compare conformational events with reaction events in the time domain | `None`          |
