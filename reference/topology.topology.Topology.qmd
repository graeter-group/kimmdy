...
| `ffpatch` | Optional\[Path\] | Path to a force field patch file. If None, no patching is applied. | `None`     |
...
| Name       | Type   | Description                                                                                                                                                | Default    |
|------------|--------|------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| `atompair` |        | A tuple of integers with the atoms indices (id, starting at 1) with `from`, the atom being moved and `to`, the atom to which the `from` atom will be bound | _required_ |
