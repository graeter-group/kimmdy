...
| [morse_transition_rate](#kimmdy.utils.morse_transition_rate) | calculates energy barrier crossing rate [in 1/ps]; barrier based on the model V = V_morse - F*X |
...
`utils.morse_transition_rate(r_curr, r_0, dissociation_energies, k_f, k_0=0.288, kT=2.479)`
