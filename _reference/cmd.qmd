...
| Name | Description |
| --- | --- |
| [analysis](#kimmdy.cmd.analysis) | Analyse existing KIMMDY runs. |
...
| [get_analysis_cmdline_args](#kimmdy.cmd.get_analysis_cmdline_args) | concat : |
...
| [remove_hydrogen](#kimmdy.cmd.remove_hydrogen) | Remove hydrogen by atom nr in a gro and topology file |

### analysis { #kimmdy.cmd.analysis }
...
`cmd.configure_logger(log_path, log_level)`
...
| `log_level` | [str](`str`)           | Log                   | _required_ |
...
### remove_hydrogen { #kimmdy.cmd.remove_hydrogen }
