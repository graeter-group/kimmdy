...
```{python}
hexala_top = read_top(Path('hexala.top'))
hexala_break_29_35 = read_top(Path("hexala_break29-35.top"))
hexala_move_34_39 = read_top(Path("hexala_move34-29.top"))
...
ala_r = read_top(Path("AlaCa_R.top"))
