...
| [calc_cumprob](#kimmdy.reaction.RecipeCollection.calc_cumprob) | Calculate cumulative probability of all contained recipe steps. |
| [from_csv](#kimmdy.reaction.RecipeCollection.from_csv) | Create a RecipeCollection object from a CSV file |
| [plot](#kimmdy.reaction.RecipeCollection.plot) | Plot reaction rates over time |
...
##### calc_cumprob { #kimmdy.reaction.RecipeCollection.calc_cumprob }

`reaction.RecipeCollection.calc_cumprob(self)`
...
##### from_csv { #kimmdy.reaction.RecipeCollection.from_csv }

`reaction.RecipeCollection.from_csv(cls, path)`
...
##### plot { #kimmdy.reaction.RecipeCollection.plot }

`reaction.RecipeCollection.plot(self, outfile, highlight_r=None, highlight_t=None)`
...
| `highlight_r` | [Recipe](`kimmdy.reaction.Recipe`) | Recipe to highlight, by default None                 | `None`     |
| `highlight_t` | [float](`float`)                   | Time at which the reactions starts                   | `None`     |

##### to_csv { #kimmdy.reaction.RecipeCollection.to_csv }

`reaction.RecipeCollection.to_csv(self, path, picked_recipe=None)`
