...
|---------------|---------------------------|------------------------------------------------------------------------|------------|
| `center`      | MDA.core.groups.Atom      | Radical atom                                                           | _required_ |
| `bonded`      | MDA.core.groups.AtomGroup | Atom group of bonded atoms. From its length the geometry is predicted. | _required_ |
