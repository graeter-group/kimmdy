...
If a PR adds multiple commits, we use the `squash and merge` option to keep 
the commit history clean. If a PR unavoidably contains changes the message 
can be edited before merging to ensure `release please` picks up all changes.
