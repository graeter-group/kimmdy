...
|----------------------|-----------------------------------------------------------------------------------------------|------------------------------------------------------|
| recipe_steps         | [Union](`typing.Union`)\[[list](`list`)\[[RecipeStep](`kimmdy.reaction.RecipeStep`)\], None\] | Single sequence of RecipeSteps to build product      |
| reaction_probability | [Union](`typing.Union`)\[[list](`list`)\[[float](`float`)\], None\]                           | Integral of reaction propensity with respect to time |
| time_step            | [Union](`typing.Union`)\[[float](`float`), None\]                                             | Time step during which the reaction occurs           |
