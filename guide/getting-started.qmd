...
git clone ssh://git@github.com/hits-mbm-dev/kimmdy.git
pushd kimmdy
...
Our starting structure is a simple ACE/NME-capped Alanine molecule:

<!-- TODO: install molstar extension -->

{{< mol ../example/example_ala/npt.gro >}}
