...
def force_correction_factor(aminoacid, atomnames):
    ...
    aas_without_correction = ['L5Y', 'L4Y', 'DOP', 'ACE', 'NME']
    ...
    if 'N' in atomnames and aminoacid not in aas_without_correction:
        baseline = float(df_forces.force.loc[(df_forces.aminoacid == aminoacid) & (
            df_forces.bondtype == 'CA-N').tolist()])
    elif 'C' in atomnames and aminoacid not in aas_without_correction:
        baseline = float(df_forces.force.loc[(df_forces.aminoacid == aminoacid) & (
