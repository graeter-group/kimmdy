...
`tools.modify_top(top_str, out_str, parameterize, removeH, gro_str, residuetypes, radicals)`
...
| Name           | Type                                                            | Description                                                                                | Default    |
|----------------|-----------------------------------------------------------------|--------------------------------------------------------------------------------------------|------------|
| `top_path`     |                                                                 | Path to GROMACS top file                                                                   | _required_ |
| `out_path`     |                                                                 | Output topology file name, stem also used for gro                                          | _required_ |
...
| `gro_path`     |                                                                 | GROMACS gro input file. Updates structure when deleting H. Output named like top output.   | _required_ |
