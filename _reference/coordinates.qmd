...
| [merge_top_moleculetypes_parameter_growth](#kimmdy.coordinates.merge_top_moleculetypes_parameter_growth) | Takes two Topologies and joins them for a smooth free-energy like parameter transition simulation |
...
### merge_top_moleculetypes_parameter_growth { #kimmdy.coordinates.merge_top_moleculetypes_parameter_growth }

`coordinates.merge_top_moleculetypes_parameter_growth(molA, molB, ff, focus_nr=None)`
