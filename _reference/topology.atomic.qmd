...
`topology.atomic.AtomType(type, id, id_sym, mass, charge, ptype, sigma, epsilon, at_num=None)`
...
`topology.atomic.NonbondParamType(i, j, id, id_sym, funct, c0=None, c1=None, c2=None)`
