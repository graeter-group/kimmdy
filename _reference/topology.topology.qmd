...
| [set_atom_is_radical](#kimmdy.topology.topology.MoleculeType.set_atom_is_radical) | Set radical status per atom and in topology based on self.radicals. |
...
##### set_atom_is_radical { #kimmdy.topology.topology.MoleculeType.set_atom_is_radical }

`topology.topology.MoleculeType.set_atom_is_radical()`
